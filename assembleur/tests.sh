...
# ./asm /Volumes/USB/corewar/champions_o/42.s
# ./asm /Volumes/USB/corewar/champions_o/Backward.s
# ./asm /Volumes/USB/corewar/champions_o/Car.s
# ./asm /Volumes/USB/corewar/champions_o/Death.s
# ./asm /Volumes/USB/corewar/champions_o/Gagnant.s
# ./asm /Volumes/USB/corewar/champions_o/Octobre_Rouge_V4.2.s
# ./asm /Volumes/USB/corewar/champions_o/Survivor.s
# # ./asm /Volumes/USB/corewar/champions_o/Torpille.s
# ./asm /Volumes/USB/corewar/champions_o/barriere.s
# ./asm /Volumes/USB/corewar/champions_o/ex.s
# ./asm /Volumes/USB/corewar/champions_o/jumper.s
# ./asm /Volumes/USB/corewar/champions_o/lde.s
# ./asm /Volumes/USB/corewar/champions_o/leeloo.s
# ./asm /Volumes/USB/corewar/champions_o/mat.s
# ./asm /Volumes/USB/corewar/champions_o/maxidef.s
# ./asm /Volumes/USB/corewar/champions_o/mortel.s
# ./asm /Volumes/USB/corewar/champions_o/new.s
# ./asm /Volumes/USB/corewar/champions_o/octobre_rouge2.s
# ./asm /Volumes/USB/corewar/champions_o/slider2.s
# ./asm /Volumes/USB/corewar/champions_o/tdc2.s
# ./asm /Volumes/USB/corewar/champions_o/tdc3.s
# ./asm /Volumes/USB/corewar/champions_o/tdc4.s
# ./asm /Volumes/USB/corewar/champions_o/test.s
# ./asm /Volumes/USB/corewar/champions_o/toto.s
# ./asm /Volumes/USB/corewar/champions_o/valid.s
...
# echo "\n\033[41m\033[1m ---> ./asm tests/error_name16.s (.name after instructions)\033[0m"
# ./asm tests/error_name16.s
# # sh /Volumes/USB/.files/valgrind/vg-in-place --leak-check=full --suppressions=/Volumes/USB/.files/valgrind/osx.supp --show-leak-kinds=all -q ./asm tests/error_name16.s
# echo "\n\033[41m\033[1m ---> ./asm tests/error_name17.s (2 fois .name)\033[0m"
# ./asm tests/error_name17.s
# # sh /Volumes/USB/.files/valgrind/vg-in-place --leak-check=full --suppressions=/Volumes/USB/.files/valgrind/osx.supp --show-leak-kinds=all -q ./asm tests/error_name17.s
# echo "\n\033[41m\033[1m ---> ./asm tests/error_name18.s (.name a la fin)\033[0m"
# ./asm tests/error_name18.s
# # sh /Volumes/USB/.files/valgrind/vg-in-place --leak-check=full --suppressions=/Volumes/USB/.files/valgrind/osx.supp --show-leak-kinds=all -q ./asm tests/error_name18.s
# echo "\n\033[41m\033[1m ---> ./asm tests/error_name19.s (name \"name\")\033[0m"
# ./asm tests/error_name19.s
# # sh /Volumes/USB/.files/valgrind/vg-in-place --leak-check=full --suppressions=/Volumes/USB/.files/valgrind/osx.supp --show-leak-kinds=all -q ./asm tests/error_name19.s
