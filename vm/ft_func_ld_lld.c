...
/*   Updated: 2016/12/12 15:33:29 by tbouder          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#define LD_IND_5		((champ->pc - 1 + (arg1 % IDX_MOD)) % MEM_SIZE) //Depart de l'instruction courante
...
#define LLD_IND_5		((champ->pc - 1 + arg1) % MEM_SIZE) //Depart de l'instruction courante
